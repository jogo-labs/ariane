...
title: Stepper
description: >-
    Affiche la progression de l'utilisateur à travers une séquence d'étapes, avec prise en
    charge des sous-étapes. À utiliser pour des parcours de création ou de modification en
    plusieurs étapes.
