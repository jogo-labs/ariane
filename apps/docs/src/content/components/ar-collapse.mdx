...
title: Collapse
description: >-
    Affiche un résumé et se déplie pour révéler du contenu additionnel. À utiliser pour
    divulguer progressivement de l'information, grouper des FAQ, ou masquer des options avancées
    — combinez plusieurs instances pour un comportement accordéon.
