...
title: Alert
description: >
    Affiche un message important intégré au contenu environnant. À utiliser pour des
    confirmations, avertissements, erreurs, ou toute information que l'utilisateur ne doit pas manquer.
variants:
    - name: default
      label: Défaut
