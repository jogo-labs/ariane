...
title: Dialog
description: >-
    Apparaît au-dessus de la page (modal) ou glisse depuis le bord de l'écran (drawer) pour
    capter l'attention de l'utilisateur. À utiliser pour des confirmations, formulaires, menus de
    navigation, ou toute tâche focalisée qui interrompt le flux principal.
