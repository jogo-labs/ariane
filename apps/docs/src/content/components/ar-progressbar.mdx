...
title: Progressbar
description: >-
    Affiche l'avancement d'une opération en cours sous forme de barre horizontale. À utiliser
    pour un upload de fichier, un parcours en plusieurs étapes, ou toute tâche à progression mesurable.
variants:
    - name: default
      label: Par défaut
