 ...
 * @cssprop --ar-datepicker-panel-max-width - Largeur maximale du popover (valeur propre, 25rem par défaut).
 * @cssprop --ar-datepicker-panel-padding - Padding interne du popover (valeur propre, 1rem par défaut).
