...
export default css`
        ...
        .stepper-list {
            .stepper-item::after {
                ...
                background-image: -webkit-gradient(
                    ...
                    left top,
                    left bottom,
                    color-stop(25%, var(--ar-color-neutral-200, #cdcfd8)),
                    color-stop(25%, transparent)
                );
                background-image: linear-gradient(
                    var(--ar-color-neutral-200, #cdcfd8) 25%,
                    transparent 25%
                );
    ...
    .stepper-item-bullet {
        ...
        -webkit-box-shadow: 0 0 0 1px
            var(--ar-stepper-bullet-border-color, var(--ar-color-neutral-200, #b0bff0)) inset;
    ...
    .stepper-list:not(.stepper-horizontal) .stepper-item:after {
        ...
        background-image: linear-gradient(var(--ar-color-neutral-200, #cdcfd8) 25%, transparent 0);
        background-size: 2px 8px;
        background-position: center 3px;
        background-repeat: repeat-y;
    }
